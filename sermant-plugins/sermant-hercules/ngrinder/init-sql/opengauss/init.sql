...
create table if not exists PERF_TEST (
    ...
    error_rate float8,
    min_response_time float8,
    response_time_percent_25 float8,
    response_time_percent_50 float8,
    response_time_percent_75 float8,
    response_time_percent_90 float8,
    response_time_percent_95 float8,
    response_time_percent_99 float8,
    max_response_time float8,
    peak_tps float8,
    port int,
    ramp_up_step int,
