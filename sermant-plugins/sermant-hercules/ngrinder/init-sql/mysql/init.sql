...
create table if not exists PERF_TEST (
    ...
    response_time_percent_25 double,
    response_time_percent_50 double,
    response_time_percent_75 double,
    response_time_percent_90 double,
    response_time_percent_95 double,
    response_time_percent_99 double,
