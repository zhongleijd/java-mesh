...
import com.huawei.argus.service.influxdb.measurement.ibmpool.CSInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.ibmpool.JCCInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.ibmpool.JDCInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.ibmpool.MNHSInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.ibmpool.NAInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.ibmpool.NSInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.ibmpool.TLInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.ibmpool.TSInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.openjdk.CpuInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.openjdk.HeapMemoryInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.openjdk.NonHeapMemoryInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.openjdk.OldGCInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.openjdk.ThreadInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.openjdk.YoungGCInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.openjdk.memorypool.CodeCacheInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.openjdk.memorypool.MetaspaceInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.openjdk.memorypool.NewGenInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.openjdk.memorypool.OldGenInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.openjdk.memorypool.PermGenInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.openjdk.memorypool.SurvivorInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.servermonitor.MemoryInfluxEntity;
import com.huawei.argus.service.influxdb.measurement.servermonitor.NetworkInfluxEntity;
...
public enum MetricType {
     ...
     * 服务器指标
     */
    SERVER("server", false, null, JvmType.NONE, null),

    /**
     * jvm中，ibm类型的jvm指标
     */
    IBM("ibm", false, null, JvmType.IBM, null),

    /**
     * jvm中，open_jdk类型的jvm指标
     */
    OPEN_JDK("open_jdk", false, null, JvmType.OPEN_JDK, null),
     ...
     * SERVER指标CPU
     */
    SERVER_CPU("server_monitor_cpu", true, SERVER, JvmType.NONE, com.huawei.argus.service.influxdb.measurement.servermonitor.CpuInfluxEntity.class),
