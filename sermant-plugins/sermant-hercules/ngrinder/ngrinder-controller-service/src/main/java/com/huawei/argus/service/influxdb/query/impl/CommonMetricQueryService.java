...
package com.huawei.argus.service.influxdb.query.impl;
...
import com.huawei.argus.service.influxdb.query.InfluxDBSqlExecutor;
...
public class CommonMetricQueryService implements IMetricQueryService {
    ...
    public CommonMetricQueryService(MetricType metricType,
        ...
        if (influxDBSqlExecutor == null) {
            throw new RuntimeException("Query executor is empty.");
        }
    ...
    public String buildSql(MonitorHostDTO monitorHostDTO) {
        if (monitorHostDTO == null) {
            throw new RuntimeException("The data for query is null.");
        }
        if (StringUtils.isEmpty(monitorHostDTO.getBucket())) {
            throw new RuntimeException("Bucket in influxdb can not be null.");
        }
