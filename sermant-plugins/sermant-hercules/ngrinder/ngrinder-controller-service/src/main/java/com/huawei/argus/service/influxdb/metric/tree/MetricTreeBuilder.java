...
import com.huawei.argus.service.influxdb.metric.tree.impl.CommonMetricNode;
import com.huawei.argus.service.influxdb.metric.tree.impl.RootMetricNode;
import com.huawei.argus.service.influxdb.query.MetricQueryServiceLoader;
...
public class MetricTreeBuilder {
     ...
     * @return metric查询服务
     */
    public RootMetricNode buildMetricTree(MonitorHostDTO monitorHostDTO) {
        RootMetricNode rootMetricNode = new RootMetricNode();
