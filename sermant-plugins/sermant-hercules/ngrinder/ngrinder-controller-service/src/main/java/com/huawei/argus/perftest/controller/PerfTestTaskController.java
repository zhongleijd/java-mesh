...
//		model.addAttribute("perfSceneList",perfSceneList);
	...
	public HttpEntity<PerfTest> saveOne(User user, PerfTest perfTest, @RequestParam(value = "perfSceneId", required = false) Long perfSceneId,
	...
	public HttpEntity<JSONObject> startOne(User user, @PathVariable("id") Long id) {
	...
	public HttpEntity<JSONObject> stopPerfTests(User user, @RequestParam(value = "ids", defaultValue = "") String ids) {
