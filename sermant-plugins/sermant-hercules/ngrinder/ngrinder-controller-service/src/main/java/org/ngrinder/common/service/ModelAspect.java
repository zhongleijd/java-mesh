...
public class ModelAspect {
	...
	public static final String EXECUTION_SAVE = "execution(* org.ngrinder.**.*Service.save*(..)) || execution(* com.huawei.argus.perftest.**.*Service.save*(..))|| execution(* com.huawei.argus.perftest.**.*Service.start*(..))";
