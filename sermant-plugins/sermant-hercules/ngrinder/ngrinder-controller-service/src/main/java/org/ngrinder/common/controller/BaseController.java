...
public class BaseController implements WebConstants {
    ...
    void initJSON() {
        ...
        successJson.put(JSON_SUCCESS, true);
        errorJson = new JSONObject();
        errorJson.put(JSON_SUCCESS, false);
    }
    ...
    public <T> HttpEntity<T> toHttpEntity(T content) {
        ...
        return new HttpEntity<T>(content, responseHeaders);
    }
    ...
    public HttpEntity<String> toJsonHttpEntity(Object content) {
        return toJsonHttpEntity(content, null);
    }
     ...
     * @return {@link HttpEntity} class containing the converted json message
     */
    public HttpEntity<JSONObject> successJsonHttpEntity() {
        HttpHeaders responseHeaders = new HttpHeaders();
        responseHeaders.set("content-type", "application/json; charset=UTF-8");
        responseHeaders.setPragma("no-cache");
     ...
     * @return {@link HttpEntity} class containing the converted json message
     */
    public HttpEntity<JSONObject> errorJsonHttpEntity() {
        HttpHeaders responseHeaders = new HttpHeaders();
        responseHeaders.set("content-type", "application/json; charset=UTF-8");
        responseHeaders.setPragma("no-cache");
