...
import com.huawei.argus.FileUtil
import com.huawei.argus.PreFlowExecutor
...
public static PerfScene scene = null
<#if body??>
            ...
            <NVPair>()
                ...
                <Cookie> cookieList = new ArrayList
                    <Cookie>()
                        ...
                        String s = FileUtil.fileToString(this.getClass().getResource("").getPath()+"sceneJsonData.txt");
                        Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd hh:mm:ss").create();
                        scene = gson.fromJson(s,PerfScene.class);
                        }
                        ...
                        @Test
                        public void test(){
                        PreFlowExecutor executor = new PreFlowExecutor(scene);
                        executor.setLogger(grinder.logger);
